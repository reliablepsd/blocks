...
// more options https://lavalamp.magicmediamuse.com/options.php
// function init
function lavalampInit() {
	jQuery('#lavalamplist').lavalamp({
		easing: 'easeOutBack'
	});
}

function lavalampInit2() {
	jQuery('#lavalamplist2').lavalamp({
		easing: 'easeOutBack'
	});
}

function lavalampInit3() {
	jQuery('#default').lavalamp();
}

function lavalampInit4() {
	$('#focus-deep').lavalamp({
		easing: 'easeOutBack',
		deepFocus: true
	});
