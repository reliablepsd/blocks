...
const importantFilesBuild = gulp.parallel(
	htmlBuild,
	jsBuild,
	cssBuild
);
...
function watchServBuild() {
	...
	gulp.watch(g.v.watch.blocks, gulp.series(importantFilesBuild, g.bsr));
...
export const distNew = gulp.series(filesProd, imageProd, watchServerProd);
